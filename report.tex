...
The trend of this fit supports equation \ref{eq:e2-linear} as outlined in \S\ref{sec:intro}.

Using the intercept of thetrendline in figure \ref{fig:air-e2}, we obtain that the initial energy of these particles is $5.43 \pm 0.03$ MeV (the accepted value for Am-147 is 5.4 MeV)
...
From the energy data, we obtain a range of $3.8 \pm 0.1$ cm and an initial energy of $5.34 \pm 0.06$ MeV.
...
Then, using this line, like before, we can compute the range of the particle, which we find is $18.64 \pm 0.016$ cm, and the initial energy of the particles is $5.54747 \pm 0.06$ MeV.
